...
import org.springframework.samples.petclinic.vet.service.VetServiceInterface;
...
class VetController {
    ...
    private final VetServiceInterface service;

    public VetController(VetServiceInterface vetService) {
